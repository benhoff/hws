				 ...
				 bool dma_idle)
{
	...
	/*
	 * A posted channel disable does not prove that an older PCI write has
	 * completed. Keep the arena mapped until the caller supplies that proof
	 * or the shared busy indication establishes it here.
	 */
	if (!dma_idle)
